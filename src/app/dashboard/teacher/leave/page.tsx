...
import { TeacherLeaveClient } from "@/components/brutal/teacher-leave-client";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <Tag color="bg-amber-300">Leave Requests</Tag>
        <h1 className="text-3xl font-black uppercase tracking-tight text-slate-900 md:text-4xl">Request Time Off</h1>
        <p className="text-sm font-medium text-slate-600">Submit a leave request for your principal to review.</p>
      </div>
      ...
      {migrationMissing ? (
        ...
        <TeacherLeaveClient schoolId={schoolId} initialRequests={requests} />
      )}
    </div>
  );
}
