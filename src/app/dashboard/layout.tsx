...
function buildNav(role: UserRole | null, staffRole?: string | null): NavItem[] {
  ...
  if (role === "teacher") {
    return [
      ...
      { href: "/dashboard/teacher/calendar", label: "Calendar", icon: "CalendarFold" as const },
      { href: "/dashboard/teacher/behavior", label: "Behavior", icon: "Flag" as const },
      { href: "/dashboard/teacher/messages", label: "Messages", icon: "Mail" as const },
      { href: "/dashboard/teacher/directory", label: "Directory", icon: "Users" as const },
